...
class Reformat(object):
    ...
    def __call__(self, res, info):
        ...
        data_bundle = dict(
            ...
            voxels_uv=voxels["voxels_uv"],
            voxel_valid=voxels["voxel_valid"],
            shape=voxels["shape"],
        ...
        if res["mode"] == "train":
            ...
            if self.double_flip:
                ...
                yflip_data_bundle = dict(
                    ...
                    voxels_uv=yflip_voxels["voxels_uv"],
                    voxel_valid=yflip_voxels["voxel_valid"],
                )
                ...
                xflip_data_bundle = dict(
                    ...
                    voxels_uv=xflip_voxels["voxels_uv"],
                    voxel_valid=xflip_voxels["voxel_valid"],
                )
                # double axis flip 
                ...
                double_flip_data_bundle = dict(
                    ...
                    voxels_uv=double_flip_voxels["voxels_uv"],
                    voxel_valid=double_flip_voxels["voxel_valid"],
                )

                if calib:
                    yflip_data_bundle["img"] = res["img"]
                    xflip_data_bundle["img"] = res["img"]
                    double_flip_data_bundle["img"] = res["img"]
